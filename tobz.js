...
module.exports = tobz = async (tobz, message) => {
    try {
        ...
        const ownerNumber = '6282144323683@c.us'
        ...
        function cekumur(obj){
            if (obj === true){
                ...
                return tobz.reply(from, `Kamu belum cukup umur untuk menggunakan UTMs BOT, min 16 tahun\n\nKamu bisa mendaftar ulang dengan cara donasi terlebih dahulu, bales ${prefix}donasi\nHubungi Owner : wa.me/6282144323683`, id) //if user is not registered
            }
        }
	...
	if (isGroupMsg && AntiStickerSpam && !isGroupAdmins && !isAdmin && !isOwner){
        ...
        if(!isCmd && isKasar && isGroupMsg && isBadword && !isGroupAdmins) { 
            ...
            if(isBadwordMsg(serial)) return
                ...
                if(body === '#mute' && isMuted(chatId) == true){
                    if(isGroupMsg) {
                        if (!isAdmin) return tobz.reply(from, '❬❗❭ 𝗔𝗗𝗠𝗜𝗡 𝗢𝗡𝗟𝗬 𝗧𝗢𝗗', id)
                ...
                if (body === '#unbanchat') {
                    if (!isOwner) return tobz.reply(from, '❬❗❭ 𝗢𝗪𝗡𝗘𝗥 𝗢𝗡𝗟𝗬 𝗧𝗢𝗗', id)
        ...
        case prefix+'ttp':
                if(isReg(obj)) return
                if(cekumur(cekage)) return
                if (!isGroupMsg) return tobz.reply(from, '❬❗❭ 𝗚𝗥𝗢𝗨𝗣 𝗢𝗡𝗟𝗬 𝗧𝗢𝗗', message.id)
                try
                {
        ...
        case prefix+'ttp2':
            ...
            if (args.length === 1) return tobz.reply(from, `Kirim perintah *#ttp2 [ Teks ]*, contoh *#ttp2 UTMs*`, id)
        ...
        case prefix+'ttg':
            if(isReg(obj)) return
            if(cekumur(cekage)) return
            if (!isGroupMsg) return tobz.reply(from, `❬❗❭ 𝗚𝗥𝗢𝗨𝗣 𝗢𝗡𝗟𝗬 𝗧𝗢𝗗`, id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik ${prefix}limit Untuk Mengecek Kuota Limit Kamu`, id)
            try {
                if (quotedMsgObj == null) {
        ...
        case prefix+'magernulis1': // BY MFARELS
            ...
            .on('exit', () => {
                tobz.sendImage(from, './mager/magernulis√/magernulis1√.jpg', 'magernulis.jpg', '❬ ✔ ❭ 𝘀𝘂𝗰𝗰𝗲𝘀𝘀 🖤\n\n*YouTube : MFarelS CH*\n*Instagram : @mfarelsyahtiawan*\n\n*© Powered By MFarelS | RajinNulis-BOT*', id)
            })
            break  // BY MFARELS
        case prefix+'toimg':
            if(isReg(obj)) return
            ...
            if (quotedMsg && quotedMsg.type == 'sticker') {
                ...
                tobz.reply(from, `❬❗❭ 𝗪𝗔𝗜𝗧, 𝗹𝗮𝗴𝗶 𝗽𝗿𝗼𝘀𝗲𝘀`, id)
                const imageBase64 = `data:${quotedMsg.mimetype};base64,${mediaData.toString('base64')}`
	...
	case prefix+'sg':
        ...
        case prefix+'daftar':  // NAMBAHIN NOMOR DI DATABASE
                ...
                const umurnye = argz[2]
                    ...
                    if(umurnye >= 40) return await tobz.reply(from, 'Kamu terlalu tua, kembali lagi ke masa muda untuk menggunakan BOT', id)
...
${desc}`)
        ...
        case prefix+'owner':
        case prefix+'creator':
            tobz.sendContact(chatId, `6282144323683@c.us`)
            tobz.reply(from, 'Tuh nomer owner ku >_<, jangan spam atau ku block kamu', id)
            break
        ...
        case prefix+'resetbadword':
            ...
            if(cekumur(cekage)) return
                    ...
                    if (!isGroupAdmins) return tobz.reply(from, '❬❗❭ 𝗔𝗗𝗠𝗜𝗡 𝗢𝗡𝗟𝗬 𝗧𝗢𝗗')  
        ...
        case prefix+'antilink':
            ...
            if(cekumur(cekage)) return
            if (!isGroupMsg) return tobz.reply(from, `❬❗❭ 𝗚𝗥𝗢𝗨𝗣 𝗢𝗡𝗟𝗬 𝗧𝗢𝗗`, id)
            if (!isGroupAdmins) return tobz.reply(from, `❬❗❭ 𝗔𝗗𝗠𝗜𝗡 𝗢𝗡𝗟𝗬 𝗧𝗢𝗗`, id)
            if (!isBotGroupAdmins) return tobz.reply(from, `❬❗❭ 𝗕𝗢𝗧 𝗛𝗔𝗥𝗨𝗦 𝗝𝗔𝗗𝗜 𝗔𝗗𝗠𝗜𝗡 𝗧𝗢𝗗`, id)
            if (args[1] == 'enable') {
        ...
        case prefix+'group':
            ...
            if (!isGroupMsg) return tobz.reply(from, '❬❗❭ 𝗚𝗥𝗢𝗨𝗣 𝗢𝗡𝗟𝗬 𝗧𝗢𝗗', id)
            if (!isGroupAdmins) return tobz.reply(from, '❬❗❭ 𝗔𝗗𝗠𝗜𝗡 𝗢𝗡𝗟𝗬 𝗧𝗢𝗗', id)
            if (!isBotGroupAdmins) return tobz.reply(from, '❬❗❭ 𝗔𝗗𝗠𝗜𝗡 𝗢𝗡𝗟𝗬 𝗧𝗢𝗗', id)
        ...
        case prefix+'bkp': // MFARELS
            if(isReg(obj)) return
            if(cekumur(cekage)) return
            if (!isGroupMsg) return tobz.reply(from, '❬❗❭ 𝗚𝗥𝗢𝗨𝗣 𝗢𝗡𝗟𝗬 𝗧𝗢𝗗', id) // MFARELS
...
➸ *Wilayah:* +${region_name}`
        ...
        case prefix+'nulis':
            ...
            const ngetikk = await axios.get('https://mhankbarbar.herokuapp.com/nulis?text=Anjim&apiKey=ApiKeyInHere')
        ...
        case prefix+'omentionall':
            if (!isGroupMsg) return tobz.reply(from, '❬❗❭ 𝗚𝗥𝗢𝗨𝗣 𝗢𝗡𝗟𝗬 𝗧𝗢𝗗', id)
            if (!isOwner, !isAdmin) return tobz.reply(from, '❬❗❭ 𝗢𝗪𝗡𝗘𝗥 𝗢𝗡𝗟𝗬 𝗧𝗢𝗗', id)
        ...
        case prefix+'okickall':
            if (!isGroupMsg) return tobz.reply(from, '❬❗❭ 𝗚𝗥𝗢𝗨𝗣 𝗢𝗡𝗟𝗬 𝗧𝗢𝗗', id)
            if (!isOwner) return tobz.reply(from, '❬❗❭ 𝗔𝗗𝗠𝗜𝗡 𝗢𝗡𝗟𝗬 𝗧𝗢𝗗', id)
            if (!isBotGroupAdmins) return tobz.reply(from, '❬❗❭ 𝗕𝗢𝗧 𝗛𝗔𝗥𝗨𝗦 𝗝𝗔𝗗𝗜 𝗔𝗗𝗠𝗜𝗡 𝗧𝗢𝗗', id)
        ...
        case prefix+'kickall':
            ...
            if (!isGroupOwner) return tobz.reply(from, '❬❗❭ 𝗢𝗪𝗡𝗘𝗥 𝗢𝗡𝗟𝗬 𝗧𝗢𝗗', id)
            if (!isBotGroupAdmins) return tobz.reply(from, '❬❗❭ 𝗕𝗢𝗧 𝗛𝗔𝗥𝗨𝗦 𝗝𝗔𝗗𝗜 𝗔𝗗𝗠𝗜𝗡 𝗧𝗢𝗗', id)
        ...
        case prefix+'oadd':
            ...
            if (!isOwner, !isAdmin) return tobz.reply(from, '❬❗❭ 𝗔𝗗𝗠𝗜𝗡 𝗢𝗡𝗟𝗬 𝗧𝗢𝗗', id)
            if (!isBotGroupAdmins) return tobz.reply(from, '❬❗❭ 𝗕𝗢𝗧 𝗛𝗔𝗥𝗨𝗦 𝗝𝗔𝗗𝗜 𝗔𝗗𝗠𝗜𝗡 𝗧𝗢𝗗', id)
            try {
...
• Limit: ${limitCount-updated.limit}`
        ...
        case prefix+'bugreport':
         ...
         case prefix+'profile':
            ...
            break
        //MATA KULIAH
        case prefix+'matakuliah':
            tobz.sendText(from, matakuliah(prefix))
            break
        case prefix+'algo':
            tobz.sendText(from, algo(prefix))
            break    
        case prefix+'pd':
            tobz.sendText(from, pd(prefix))
            break    
        case prefix+'kalkulus':
            tobz.sendText(from, kalkulus(prefix))
            break    
        case prefix+'pancasila':
            tobz.sendText(from, pancasila(prefix))
            break    
        case prefix+'kkpi':
            tobz.sendText(from, kkpi(prefix))
            break    
        case prefix+'binggris':
            tobz.sendText(from, binggris(prefix))
            break    
        case prefix+'pti':
            tobz.sendText(from, pti(prefix))
            break    
        case prefix+'entr':
            tobz.sendText(from, entr(prefix))
            break    
        // LIST MENU
        case prefix+'runtime':
	    ...
	    case prefix+'help':
            ...
            break
        case prefix+'utmgroup':
            tobz.reply(from, `Link Group UTM : https://chat.whatsapp.com/FrMRew28mbi16q5U0r9nJf\nJangan Lupa Join Ya Kak ${pushname}`, id)
            break
